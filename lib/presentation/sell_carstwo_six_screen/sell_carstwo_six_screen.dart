...
class SellCarstwoSixScreen extends StatelessWidget {
  const SellCarstwoSixScreen({Key? key}) : super(key: key);
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Text("Expected Selling Price",
                              overflow: TextOverflow.ellipsis,
                              textAlign: TextAlign.left,
                      ...
                      Container(
                          ...
                          child: Stack(alignment: Alignment.center, children: [
                            ...
                            Align(
                                alignment: Alignment.center,
                                child: Padding(
                                    padding:  EdgeInsets.only(left: 74, right: 73),
                                    child: Row(
                                        mainAxisAlignment:
                      ...
                      Padding(
                          padding:  EdgeInsets.only(left: 64, top: 5, right: 48),
                          child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Opacity(
                                    opacity: 0.5,
                                    child: Text("Fair Condition",
                                        overflow: TextOverflow.ellipsis,
                                        textAlign: TextAlign.left,
                                        style: CustomTextStyles
                                            .labelMediumBlack90010_2)),
                                Opacity(
                                    opacity: 0.5,
                      ...
                      Padding(
                          padding:  EdgeInsets.only(left: 61, top: 3, right: 61),
                          child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("₹ 8.8 Lakh",
